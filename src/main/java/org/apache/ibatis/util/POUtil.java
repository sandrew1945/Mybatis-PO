...
public class POUtil
{
	 ...
	 * @return
	 */
	public static Object invokeGetMethodByField(Object po, String fieldName)
	{
		Object value = null;
	 ...
	 * @return
	 */
	public static Object invokeSetMethodByField(Object po, String fieldName, Object setValue)
	{
		Object value = null;
		Class<?> cls = po.getClass();
	 ...
	 * @return
	 */
	public static LinkedList<Object> encapParams(POMapping mapping, Object... po)
	{
		// 封装参数List
	 ...
	 * @throws Exception 
	 */
	public static Object getValue(ResultSet rs, String colName, Class targetType) throws Exception
	{
		try
		{
			...
			{
				throw new Exception("not supported type:" + targetType);
			}
		}
		catch (SQLException e)
		{
			throw new Exception("get " + colName + " error", e);
		}
		catch (Exception e)
		{
